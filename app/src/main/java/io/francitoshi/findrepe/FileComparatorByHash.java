...
import io.nut.headless.io.FileHash;
 ...
 * @author franci
 */
public class FileComparatorByHash implements Comparator<VirtualFile>
{
    private final boolean half;
    private static final Object lock = new Object();
    private static final Map<VirtualFile,WeakReference<FileHash>> map = Collections.synchronizedMap(new WeakHashMap<>());
